...
__global__ void pau_cuda_forward_D_kernel_$degs[0]_$degs[1](const bool training, const unsigned long long iteration, const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
...
at::Tensor pau_cuda_forward_D_$degs[0]_$degs[1](const bool training, const unsigned long long iteration, torch::Tensor x, torch::Tensor n, torch::Tensor d){
...
template <typename scalar_t>
__global__ void pau_cuda_backward_D_kernel_$degs[0]_$degs[1](
...
std::vector<torch::Tensor> pau_cuda_backward_D_$degs[0]_$degs[1](const bool training, const unsigned long long iteration, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    const auto x_size = x.numel();
