...
__global__ void pau_cuda_forward_A_kernel_3_3( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
...
at::Tensor pau_cuda_forward_A_3_3(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_A_3_3", ([&] {
    pau_cuda_forward_A_kernel_3_3<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
//dF/da_i = x^i/Q(X), i \in {0,3}
//dF/db_i = (-P(X)/Q(X)^2) * sign(b_i) * |X^{i+1}| , i \in {0,3}

template <typename scalar_t>
__global__ void pau_cuda_backward_A_kernel_3_3(
...
std::vector<torch::Tensor> pau_cuda_backward_A_3_3(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_A_3_3", ([&] {
    pau_cuda_backward_A_kernel_3_3<scalar_t>
        <<<16, blockSize>>>(
...
template <typename scalar_t>
__global__ void pau_cuda_forward_A_kernel_4_4( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_A_4_4(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_A_4_4", ([&] {
    pau_cuda_forward_A_kernel_4_4<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
//S(X) = sign(X) * ( |b_0| + 2|b_1||X| + 3|b_2||X|^2 ...)
//dF/dx = (-P(X)/Q(X)^2)*S(X) + R(X)/Q(X)
//dF/da_i = x^i/Q(X), i \in {0,4}
//dF/db_i = (-P(X)/Q(X)^2) * sign(b_i) * |X^{i+1}| , i \in {0,4}

template <typename scalar_t>
__global__ void pau_cuda_backward_A_kernel_4_4(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_A_4_4(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_A_4_4", ([&] {
    pau_cuda_backward_A_kernel_4_4<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_A_kernel_5_5( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_A_5_5(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_A_5_5", ([&] {
    pau_cuda_forward_A_kernel_5_5<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
//dF/db_i = (-P(X)/Q(X)^2) * sign(b_i) * |X^{i+1}| , i \in {0,5}

template <typename scalar_t>
__global__ void pau_cuda_backward_A_kernel_5_5(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_A_5_5(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_A_5_5", ([&] {
    pau_cuda_backward_A_kernel_5_5<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_A_kernel_6_6( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_A_6_6(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_A_6_6", ([&] {
    pau_cuda_forward_A_kernel_6_6<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
//S(X) = sign(X) * ( |b_0| + 2|b_1||X| + 3|b_2||X|^2 ...)
//dF/dx = (-P(X)/Q(X)^2)*S(X) + R(X)/Q(X)
//dF/da_i = x^i/Q(X), i \in {0,6}
//dF/db_i = (-P(X)/Q(X)^2) * sign(b_i) * |X^{i+1}| , i \in {0,6}

template <typename scalar_t>
__global__ void pau_cuda_backward_A_kernel_6_6(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_A_6_6(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_A_6_6", ([&] {
    pau_cuda_backward_A_kernel_6_6<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_A_kernel_7_7( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_A_7_7(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_A_7_7", ([&] {
    pau_cuda_forward_A_kernel_7_7<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
//dF/db_i = (-P(X)/Q(X)^2) * sign(b_i) * |X^{i+1}| , i \in {0,7}

template <typename scalar_t>
__global__ void pau_cuda_backward_A_kernel_7_7(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_A_7_7(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_A_7_7", ([&] {
    pau_cuda_backward_A_kernel_7_7<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_A_kernel_8_8( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_A_8_8(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_A_8_8", ([&] {
    pau_cuda_forward_A_kernel_8_8<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
//S(X) = sign(X) * ( |b_0| + 2|b_1||X| + 3|b_2||X|^2 ...)
//dF/dx = (-P(X)/Q(X)^2)*S(X) + R(X)/Q(X)
//dF/da_i = x^i/Q(X), i \in {0,8}
//dF/db_i = (-P(X)/Q(X)^2) * sign(b_i) * |X^{i+1}| , i \in {0,8}

template <typename scalar_t>
__global__ void pau_cuda_backward_A_kernel_8_8(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_A_8_8(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_A_8_8", ([&] {
    pau_cuda_backward_A_kernel_8_8<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
at::Tensor pau_cuda_forward_A_5_4(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_A_5_4", ([&] {
...
std::vector<torch::Tensor> pau_cuda_backward_A_5_4(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_A_5_4", ([&] {
...
template <typename scalar_t>
__global__ void pau_cuda_forward_A_kernel_7_6( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_A_7_6(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_A_7_6", ([&] {
    pau_cuda_forward_A_kernel_7_6<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_A_kernel_7_6(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_A_7_6(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_A_7_6", ([&] {
    pau_cuda_backward_A_kernel_7_6<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_B_kernel_3_3( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_B_3_3(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_B_3_3", ([&] {
    pau_cuda_forward_B_kernel_3_3<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
//dF/dx = (-P(X)/Q(X)^2)*S(X) + R(X)/Q(X)
//dF/da_i = x^i/Q(X), i \in {0,3}
//dF/db_i = (-P(X)/Q(X)^2) * sign(A(X)) * X^{i+1} , i \in {0,3}


template <typename scalar_t>
__global__ void pau_cuda_backward_B_kernel_3_3(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_B_3_3(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_B_3_3", ([&] {
    pau_cuda_backward_B_kernel_3_3<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_B_kernel_4_4( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_B_4_4(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_B_4_4", ([&] {
    pau_cuda_forward_B_kernel_4_4<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_B_kernel_4_4(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_B_4_4(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_B_4_4", ([&] {
    pau_cuda_backward_B_kernel_4_4<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_B_kernel_5_5( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_B_5_5(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_B_5_5", ([&] {
    pau_cuda_forward_B_kernel_5_5<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
//dF/dx = (-P(X)/Q(X)^2)*S(X) + R(X)/Q(X)
//dF/da_i = x^i/Q(X), i \in {0,5}
//dF/db_i = (-P(X)/Q(X)^2) * sign(A(X)) * X^{i+1} , i \in {0,5}


template <typename scalar_t>
__global__ void pau_cuda_backward_B_kernel_5_5(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_B_5_5(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_B_5_5", ([&] {
    pau_cuda_backward_B_kernel_5_5<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_B_kernel_6_6( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_B_6_6(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_B_6_6", ([&] {
    pau_cuda_forward_B_kernel_6_6<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_B_kernel_6_6(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_B_6_6(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_B_6_6", ([&] {
    pau_cuda_backward_B_kernel_6_6<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_B_kernel_7_7( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_B_7_7(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_B_7_7", ([&] {
    pau_cuda_forward_B_kernel_7_7<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
//dF/dx = (-P(X)/Q(X)^2)*S(X) + R(X)/Q(X)
//dF/da_i = x^i/Q(X), i \in {0,7}
//dF/db_i = (-P(X)/Q(X)^2) * sign(A(X)) * X^{i+1} , i \in {0,7}


template <typename scalar_t>
__global__ void pau_cuda_backward_B_kernel_7_7(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_B_7_7(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_B_7_7", ([&] {
    pau_cuda_backward_B_kernel_7_7<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_B_kernel_8_8( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_B_8_8(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_B_8_8", ([&] {
    pau_cuda_forward_B_kernel_8_8<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
//dF/dx = (-P(X)/Q(X)^2)*S(X) + R(X)/Q(X)
//dF/da_i = x^i/Q(X), i \in {0,8}
//dF/db_i = (-P(X)/Q(X)^2) * sign(A(X)) * X^{i+1} , i \in {0,8}


template <typename scalar_t>
__global__ void pau_cuda_backward_B_kernel_8_8(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_B_8_8(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_B_8_8", ([&] {
    pau_cuda_backward_B_kernel_8_8<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
at::Tensor pau_cuda_forward_B_5_4(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_B_5_4", ([&] {
...
std::vector<torch::Tensor> pau_cuda_backward_B_5_4(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_B_5_4", ([&] {
...
template <typename scalar_t>
__global__ void pau_cuda_forward_B_kernel_7_6( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_B_7_6(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_B_7_6", ([&] {
    pau_cuda_forward_B_kernel_7_6<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_B_kernel_7_6(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_B_7_6(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_B_7_6", ([&] {
    pau_cuda_backward_B_kernel_7_6<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_C_kernel_3_3( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_C_3_3(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_C_3_3", ([&] {
    pau_cuda_forward_C_kernel_3_3<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_C_kernel_3_3(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_C_3_3(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_C_3_3", ([&] {
    pau_cuda_backward_C_kernel_3_3<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_C_kernel_4_4( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_C_4_4(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_C_4_4", ([&] {
    pau_cuda_forward_C_kernel_4_4<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_C_kernel_4_4(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_C_4_4(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_C_4_4", ([&] {
    pau_cuda_backward_C_kernel_4_4<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_C_kernel_5_5( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_C_5_5(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_C_5_5", ([&] {
    pau_cuda_forward_C_kernel_5_5<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_C_kernel_5_5(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_C_5_5(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_C_5_5", ([&] {
    pau_cuda_backward_C_kernel_5_5<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_C_kernel_6_6( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_C_6_6(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_C_6_6", ([&] {
    pau_cuda_forward_C_kernel_6_6<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_C_kernel_6_6(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_C_6_6(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_C_6_6", ([&] {
    pau_cuda_backward_C_kernel_6_6<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_C_kernel_7_7( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_C_7_7(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_C_7_7", ([&] {
    pau_cuda_forward_C_kernel_7_7<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_C_kernel_7_7(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_C_7_7(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_C_7_7", ([&] {
    pau_cuda_backward_C_kernel_7_7<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_C_kernel_8_8( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_C_8_8(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_C_8_8", ([&] {
    pau_cuda_forward_C_kernel_8_8<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_C_kernel_8_8(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_C_8_8(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_C_8_8", ([&] {
    pau_cuda_backward_C_kernel_8_8<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
at::Tensor pau_cuda_forward_C_5_4(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_C_5_4", ([&] {
...
std::vector<torch::Tensor> pau_cuda_backward_C_5_4(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_C_5_4", ([&] {
...
template <typename scalar_t>
__global__ void pau_cuda_forward_C_kernel_7_6( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_C_7_6(torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_C_7_6", ([&] {
    pau_cuda_forward_C_kernel_7_6<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
            d.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_C_kernel_7_6(
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b,
...
std::vector<torch::Tensor> pau_cuda_backward_C_7_6(torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_C_7_6", ([&] {
    pau_cuda_backward_C_kernel_7_6<scalar_t>
        <<<16, blockSize>>>(
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_D_kernel_3_3(const bool training, const unsigned long long iteration, const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_D_3_3(const bool training, const unsigned long long iteration, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_D_3_3", ([&] {
    pau_cuda_forward_D_kernel_3_3<scalar_t>
        <<<numBlocks, blockSize>>>(
            training, iteration,
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_D_kernel_3_3(
...
std::vector<torch::Tensor> pau_cuda_backward_D_3_3(const bool training, const unsigned long long iteration, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_D_3_3", ([&] {
    pau_cuda_backward_D_kernel_3_3<scalar_t>
        <<<16, blockSize>>>(
            training, iteration,
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_D_kernel_4_4(const bool training, const unsigned long long iteration, const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_D_4_4(const bool training, const unsigned long long iteration, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_D_4_4", ([&] {
    pau_cuda_forward_D_kernel_4_4<scalar_t>
        <<<numBlocks, blockSize>>>(
            training, iteration,
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_D_kernel_4_4(
    const bool training, const unsigned long long iteration,
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
...
std::vector<torch::Tensor> pau_cuda_backward_D_4_4(const bool training, const unsigned long long iteration, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_D_4_4", ([&] {
    pau_cuda_backward_D_kernel_4_4<scalar_t>
        <<<16, blockSize>>>(
            training, iteration,
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_D_kernel_5_5(const bool training, const unsigned long long iteration, const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_D_5_5(const bool training, const unsigned long long iteration, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_D_5_5", ([&] {
    pau_cuda_forward_D_kernel_5_5<scalar_t>
        <<<numBlocks, blockSize>>>(
            training, iteration,
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_D_kernel_5_5(
    const bool training, const unsigned long long iteration,
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
...
std::vector<torch::Tensor> pau_cuda_backward_D_5_5(const bool training, const unsigned long long iteration, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_D_5_5", ([&] {
    pau_cuda_backward_D_kernel_5_5<scalar_t>
        <<<16, blockSize>>>(
            training, iteration,
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_D_kernel_6_6(const bool training, const unsigned long long iteration, const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_D_6_6(const bool training, const unsigned long long iteration, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_D_6_6", ([&] {
    pau_cuda_forward_D_kernel_6_6<scalar_t>
        <<<numBlocks, blockSize>>>(
            training, iteration,
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_D_kernel_6_6(
    const bool training, const unsigned long long iteration,
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
...
std::vector<torch::Tensor> pau_cuda_backward_D_6_6(const bool training, const unsigned long long iteration, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_D_6_6", ([&] {
    pau_cuda_backward_D_kernel_6_6<scalar_t>
        <<<16, blockSize>>>(
            training, iteration,
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_D_kernel_7_7(const bool training, const unsigned long long iteration, const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_D_7_7(const bool training, const unsigned long long iteration, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_D_7_7", ([&] {
    pau_cuda_forward_D_kernel_7_7<scalar_t>
        <<<numBlocks, blockSize>>>(
            training, iteration,
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_D_kernel_7_7(
    const bool training, const unsigned long long iteration,
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
...
std::vector<torch::Tensor> pau_cuda_backward_D_7_7(const bool training, const unsigned long long iteration, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_D_7_7", ([&] {
    pau_cuda_backward_D_kernel_7_7<scalar_t>
        <<<16, blockSize>>>(
            training, iteration,
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_forward_D_kernel_8_8(const bool training, const unsigned long long iteration, const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_D_8_8(const bool training, const unsigned long long iteration, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_D_8_8", ([&] {
    pau_cuda_forward_D_kernel_8_8<scalar_t>
        <<<numBlocks, blockSize>>>(
            training, iteration,
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_D_kernel_8_8(
    const bool training, const unsigned long long iteration,
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
...
std::vector<torch::Tensor> pau_cuda_backward_D_8_8(const bool training, const unsigned long long iteration, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_D_8_8", ([&] {
    pau_cuda_backward_D_kernel_8_8<scalar_t>
        <<<16, blockSize>>>(
            training, iteration,
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
...
at::Tensor pau_cuda_forward_D_5_4(const bool training, const unsigned long long iteration, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_D_5_4", ([&] {
...
std::vector<torch::Tensor> pau_cuda_backward_D_5_4(const bool training, const unsigned long long iteration, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_D_5_4", ([&] {
...
template <typename scalar_t>
__global__ void pau_cuda_forward_D_kernel_7_6(const bool training, const unsigned long long iteration, const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
    const scalar_t* __restrict__ b, scalar_t* __restrict__ result, size_t x_size) {
...
at::Tensor pau_cuda_forward_D_7_6(const bool training, const unsigned long long iteration, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_forward_D_7_6", ([&] {
    pau_cuda_forward_D_kernel_7_6<scalar_t>
        <<<numBlocks, blockSize>>>(
            training, iteration,
            x.data_ptr<scalar_t>(),
            n.data_ptr<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backward_D_kernel_7_6(
    const bool training, const unsigned long long iteration,
    const scalar_t* __restrict__ grad_output,
    const scalar_t* __restrict__ x,
    const scalar_t* __restrict__ a,
...
std::vector<torch::Tensor> pau_cuda_backward_D_7_6(const bool training, const unsigned long long iteration, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.scalar_type(), "pau_cuda_backward_D_7_6", ([&] {
    pau_cuda_backward_D_kernel_7_6<scalar_t>
        <<<16, blockSize>>>(
            training, iteration,
            grad_output.data_ptr<scalar_t>(),
            x.data_ptr<scalar_t>(),
